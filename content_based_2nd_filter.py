...
#this returns a dictionary with key as genre and movies stored in vector
def get_movies_with_genre(cursor):
	...
	for movie in genre:
		if(movie[0] in movie_with_genre):
			movie_with_genre[movie[1]].append(movie[0])
		else
			movie_with_genre[movie[1]] = [movie[0]]
	return movie_with_genre

def content_based_filter():
	print("will do something")
	
def content_based_filter_2nd_controller():
...
content_based_2nd_filter_controller(all_the_user_rating,cursor)
